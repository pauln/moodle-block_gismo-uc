...
(function($) {
    ...
    $.jqplot.debug = 0;
    $.jqplot.config = {debug:0,enablePlugins:true,defaultHeight:300,defaultWidth:400,UTCAdjust:false,timezoneOffset:new Date(new Date().getTimezoneOffset()*60000),errorMessage:"",errorBackground:"",errorBorder:"",errorFontFamily:"",errorFontSize:"",errorFontStyle:"",errorFontWeight:"",catchErrors:false,defaultTickFormatString:"%.1f"};
   ...
   $.jqplot.ColorGenerator = function(colors) {
    ...
    $.jqplot.MarkerRenderer.prototype.drawSquare = function(x, y, ctx, fill, options) {
        var stretch = 1.0;
        var mySize = fill?this.size:this.size-this.lineWidth;
        var dx = mySize/2/stretch;
        var dy = mySize/2*stretch;
