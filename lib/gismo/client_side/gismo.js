function gismo(config, srv_data, static_data, course_start_time, current_time) {
        ...
        switch (this.get_full_type()) {
            ...
            case 'student-resources-access':
                if (this.static_data["users"].length > 0 && this.util.get_assoc_array_length(this.current_analysis.data) > 0) {
                    ...
                    for (item in this.current_analysis.data) {
                        if (jQuery.inArray(this.current_analysis.data[item].resid_sra, selected_items["resources"]) != -1) {
                    ...
                    if (lines.length > 0 && xticks.length > 0) {
                        ...
                        prepared_data["y_label"] = "Accesses on resources";                        
                    }
                }   
                break;
            case 'student-resources-access:users-details':
                if (this.static_data["resources"].length > 0 && this.util.get_assoc_array_length(this.current_analysis.data) > 0) {
                    ...
                    for (item in this.static_data["resources"]) {
                        if (jQuery.inArray((this.static_data["resources"][item].id).toString(), selected_items["resources"]) != -1) {
                            yticks.push(this.util.intelligent_substring(this.static_data["resources"][item].name, true));
                            yticks_pos[this.static_data["resources"][item].id] = count;
                            count++;
                        }    
                    }
                    // build line
                    for (item in this.current_analysis.data) {                        
                        if (jQuery.inArray((this.current_analysis.data[item].resid_sra).toString(), selected_items["resources"]) != -1) {
                    ...
                    if (lines.length > 0 && yticks.length > 0) {
                        ...
                        prepared_data["yticks_min_len"] = 13;
                        prepared_data["x_label"] = "Timeline";
                        prepared_data["y_label"] = "Resources";
                    }       
                }
                break;
                ...
                if (this.static_data["users"].length > 0 && this.static_data["resources"].length > 0 && this.util.get_assoc_array_length(this.current_analysis.data) > 0) {
                    ...
                    for (item in this.static_data["resources"]) {
                        if (jQuery.inArray((this.static_data["resources"][item].id).toString(), selected_items["resources"]) != -1) {
                            ...
                            xticks_pos[this.static_data["resources"][item].id] = count;
                            count++;
                        }       
                    }
                    count = 1;
                    ...
                    for (item in this.current_analysis.data) {
                        ...
                        if (jQuery.inArray((userid).toString(), selected_items["users"]) != -1 &&
                            jQuery.inArray((resid).toString(), selected_items["resources"]) != -1) {
                    ...
                    if (used_lines.length > 0 && xticks.length > 0) {
                        ...
                        prepared_data["x_label"] = "Resources";
                ...
                if (this.static_data["resources"].length > 0 && this.util.get_assoc_array_length(this.current_analysis.data) > 0) {
                    ...
                    for (item in this.static_data["resources"]) {
                        if (jQuery.inArray((this.static_data["resources"][item].id).toString(), selected_items["resources"]) != -1) {
                            lines.push(0);
                            xticks.push(this.util.intelligent_substring(this.static_data["resources"][item].name, true));
                            yticks.push((this.static_data["resources"][item].id).toString());
                        }
                    }
                ...
                if (this.static_data["users"].length > 0 && this.static_data["assignments"].length > 0 && this.util.get_assoc_array_length(this.current_analysis.data) > 0) {
                    ...
                    for (item in this.static_data["assignments"]) {
                        if (jQuery.inArray((this.static_data["assignments"][item].id).toString(), selected_items["assignments"]) != -1) {
                            yticks.push(this.util.intelligent_substring(this.static_data["assignments"][item].name, true));
    ...
    this.options = function () {
        ...
        // set form values
        $("#dialog #include_hidden_items_yes").attr('checked', (g.cfg.include_hidden_items == 1));
        $("#dialog #include_hidden_items_no").attr('checked', (g.cfg.include_hidden_items == 0));
        $("#dialog #charts_base_color_red").attr('checked', (g.cfg.chart_base_color == 1));
        $("#dialog #charts_base_color_green").attr('checked', (g.cfg.chart_base_color == 2));
        $("#dialog #charts_base_color_blue").attr('checked', (g.cfg.chart_base_color == 3));
