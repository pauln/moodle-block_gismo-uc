function left_menu(g) {
    ...
    this.set_menu = function (fresh) {
        // enabled menus (def)
        var all = ['users', 'resources', 'books', 'forums', 'glossaries', 'wikis', 'assignments', 'quizzes'];
        var enabled = ['users', 'resources', 'books', 'forums', 'glossaries', 'wikis', 'assignments', 'quizzes'];
        var list = enabled[0];
